...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002171792473"))

TG_BOT_WORKERS = int(os.environ.get("TG_BOT_WORKERS", "4"))

#start message
START_MSG = os.environ.get("START_MESSAGE", "<b>Hello {first}\n\n⚝ Do not Waste Your Time Only Admin Can Access This Bot ⚝\n\n<a href='https://t.me/FILMCORNERALL'>❀ Tᴇᴀᴍ Fɪʟᴍ Cᴏʀɴᴇʀ ❀</a></b>")
try:
    ADMINS=[]
